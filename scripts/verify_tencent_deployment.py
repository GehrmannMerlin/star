...
def main() -> None:
    ...
    commands = {
        ...
        "local-app": "curl -sS -o /tmp/codex-stellaris-index.html -w 'web=%{http_code}\\n' http://127.0.0.1:3218/zhengwujianli/; grep -o '<title>[^<]*</title>' /tmp/codex-stellaris-index.html; curl -sS -o /dev/null -w 'backend_health=%{http_code}\\n' http://127.0.0.1:3217/health; rm -f /tmp/codex-stellaris-index.html",
