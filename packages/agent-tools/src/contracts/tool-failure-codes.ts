export const ToolFailureCode = {
  ...
  RESEARCH_TOOL_NOT_ALLOWED_DURING_SUBMISSION_REPAIR:
    "RESEARCH_TOOL_NOT_ALLOWED_DURING_SUBMISSION_REPAIR",
  /** STEP 20.1: submit_investigator_evidence contract repair codes. */
  EVIDENCE_SCHEMA_VALIDATION_FAILED: "EVIDENCE_SCHEMA_VALIDATION_FAILED",
  EVIDENCE_SCHEMA_REPAIR_EXHAUSTED: "EVIDENCE_SCHEMA_REPAIR_EXHAUSTED",
  EVIDENCE_REPEATED_SCHEMA_ERROR: "EVIDENCE_REPEATED_SCHEMA_ERROR",
  EVIDENCE_TOOL_NOT_CALLED: "EVIDENCE_TOOL_NOT_CALLED",
  EVIDENCE_PROVIDER_TOOL_CALL_INVALID: "EVIDENCE_PROVIDER_TOOL_CALL_INVALID",
} as const;
